...
mainboard = {
    ...
    //     responsive: true,
    //     data: {
    //       labels: ["Monica", "Asdrubale", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
    //       datasets: [{
    //         label: "Active Users",
    //         borderColor: "#f96332",
    ...
    //         borderWidth: 2,
    //         data: [2, 1, 1, 1, 1, 1, 1, 434, 568, 610, 700, 630]
    //       }]
    //     },
  ...
  // CHart 3
      ...
      var a = {
        type: "bar",
        data: {
          labels: ["a", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
          datasets: [{
